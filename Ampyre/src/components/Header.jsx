...
import logoDark from "../assets/blackLogo.png";
              ...
              <div className="flex items-center gap-4 relative">
                ...
                {isMenuOpen && (
                  <div
                    ...
                    style={{
                      ...
                      boxShadow: popShadow,
                      border: theme === "light" ? "1px solid #E9E2F9" : "1px solid #1B1B1B",
                    }}
                  >
                    <Link
                      to="/settings"
                ...
                {user?.photoURL ? (
                  ...
                  >
                    <User
                      className="w-6 h-6"
                      style={{ color: theme === "light" ? "#6B54D3" : "#3CB14A" }}
                    />
                  </div>
                )}
              </div>
      ...
      {isMobileOpen && (
        <div
          ...
          style={{
            background: surfaceBg,
            boxShadow: popShadow,
            borderTop: theme === "light" ? "1px solid #E9E2F9" : "1px solid #1B1B1B",
          }}
        >
          {isHomePage ? (
